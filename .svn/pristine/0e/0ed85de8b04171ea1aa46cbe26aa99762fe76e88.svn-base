// $Id: omniture.js 37945 2008-07-23 13:16:54Z vangogh $
...
function omnCustEvents () {
	if ((s.events=='') || (s.events==null)) return;
...
var s_account='nissaninfiniticom';
...
s.linkInternalFilters="javascript:,nissanusa.com,infinitiusa.com"
s.linkLeaveQueryString=false
s.linkTrackVars="None"
s.linkTrackEvents="None"
s.fpcdomain='infinitiusa.com';
